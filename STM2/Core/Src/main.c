...
//				HAL_GPIO_WritePin(Debug2_GPIO_Port,Debug2_Pin,1);
			uint8_t sample8 = mean >> 4; //im currently just shifting the value from 12 bits down to 8 bits. Sending 12 bits is WHAT IM STUCK ON
			//PLEASE HELP I DONT KNOW HOW TO RELIABLY SEND 12 BITS OVER TO PYTHON
			//PLEASE HELP I DONT KNOW HOW TO RELIABLY SEND 12 BITS OVER TO PYTHON
			//PLEASE HELP I DONT KNOW HOW TO RELIABLY SEND 12 BITS OVER TO PYTHON
			//PLEASE HELP I DONT KNOW HOW TO RELIABLY SEND 12 BITS OVER TO PYTHON
			//PLEASE HELP I DONT KNOW HOW TO RELIABLY SEND 12 BITS OVER TO PYTHON
