...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if (distance_cm<= 10){
		  recording = 1;
	  }else if (distance_cm > 12){ // buffer as per specification (might need to discuss further)
		  recording = 0;
	  }
...
double Get_Distance()
{
	...
	int echo_time = __HAL_TIM_GET_COUNTER(&htim16);
	double dist_cm = echo_time/divider;
    return dist_cm;
